...
<div class="row">
   ...
   <form  name="select" id="select" class="">
   <h6> Sort by Status</h6>
            <div>
              <select name="status" id="p_status" onchange="findSelect();" class="px-2 custom-select form-control  m-auto">
...
<div class="col-md-4 col-sm-12">
   <form name="select_state" id="select_state" class="">
   <h6> Sort by State</h6>
            <div>
              <select name="state" id="p_state" onchange="selectState();"  class="px-2 custom-select form-control  m-auto">
   ...
   <div class="col-md-4 col-sm-12">
    <h6> Search by Name</h6>
        <form name="search" id="search" class="w-100">
	       <input type="text" name="patient_keyword" onkeyup="findmatch();" class="form-control" placeholder="Enter Name">
        </form>
    </div>
    ...
    <div class="row-header"> <h5><?php if(isset($result_type)){echo $result_type;} else {echo "All Patients";}?></h5></div>

        <?php 

        if(isset($status)){
        
        $data = "SELECT * FROM `patients` WHERE `status`"."='$status' ";

         } else if(isset($state)){

        $data = "SELECT * FROM `patients` WHERE `state`"."='$state' ";
...
function findmatch(){
 ...
 $(".dp").mouseleave(function(){
   $(this).animate({
	...
	xmlhttp.open('GET', 'search.inc.php?patient_keyword='+document.search.patient_keyword.value, true);
	xmlhttp.send();
}
...
$(".dp").click(function(){
 ...
 $(".dp").mouseleave(function(){
   $(this).animate({
	...
	xmlhttp.open('GET', 'select.inc.php?p_status='+document.select.p_status.value, true);
	xmlhttp.send();
}
...
$(".dp").click(function(){
 ...
 $(".dp").mouseleave(function(){
   $(this).animate({
	...
	xmlhttp.open('GET', 'select.inc.php?p_state='+document.select_state.p_state.value, true);
	xmlhttp.send();
}
 </script>
</body>
