...
<div class="col col-sm-12 col-md-6 col-lg-4 p-3">
                 <a href="admin_view_patients.php">
                    <div class="card border-success text-center">
                        <div class="card-body">
                                <img class="invoice" src="../images/icons/download.png" alt="" style="width:80px; height:80px;">
                            <h5 class="text-dark">
                                Patients
                            </h5>
                            <p class="text-success">
...
<div class="col col-sm-12 col-md-6 col-lg-4 p-3">
               <a href="admin_reports.php">
                    <div class="card border-success text-center">
                        <div class="card-body">
                                <img class="invoice" src="../images/icons/reports.png" alt="" style="width:100px; height:80px;">
                            <h5 class="text-dark">
                           Messages
                            </h5>
                            <p class="text-success">
