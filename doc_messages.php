...
<div class="col-1 mt-2">
         <div class=""><a href="doc_dashboard.php" class="btn btn-sm btn-success" style="">Back &#8656;</a></div>
</div>                      

 <div class="col-5" style="position:relative;">
<div class="col col-sm-12 col-md- p-3" style="max-width:auto;">
            <a href="doc_conversations.php">
...
<div class="col-5" style="position:relative;">
             ...
             <a href="doc_to_doc_conversations.php">
                    <div class="card border-success text-center">
                        <div class="card-body">
                                <img class="invoice" src="../images/icons/doctodoc.jpg" alt="" style="width:100px; height:80px;">
                            <h5 class="text-dark">
                                Doctors
                            </h5>
                            <p class="text-success">
                            Resume ongoing chats with other doctors
                            </p>
                        </div>
                        </a>
                    </div>
